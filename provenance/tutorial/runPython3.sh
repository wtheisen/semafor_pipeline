...
#export PYTHONPATH=../notredame/:../featureExtraction/:../indexConstruction/:../provenanceFiltering:../provenanceGraphConstruction:../helperLibraries/:/root/faiss/:/home/jbrogan4/Documents/Projects/Medifor/faiss/:$PYTHONPATH
...
mkdir index_delf1000_Training
mkdir index
mkdir filtering_results
mkdir filtering_results/json

#this step is optional
#python3 indexConstructionDriver.py --FeatureFileList delf_mfc18eval_ffl --IndexOutputFile index_delf1000_Training/parameter
#python3 indexTrainingDriver.py  --FeatureFileList delf1M_ffl --IndexOutputFile index_delf1000_Training/parameters

python3 indexConstructionDriver.py  --FeatureFileList delf1M_ffl --IndexOutputFile index/mfc18_delf100_index --TrainedIndexParams /scratch365/jbrogan4/Medifor/GPU_Prov_Filtering/provenance/tutorial/index_delf1000_Training/parameters
