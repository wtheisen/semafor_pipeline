...
imageRoot1=/media/wtheisen/scratch2/Reddit_Prov_Dataset_v6/Data
...
featureFolder=/media/wtheisen/scratch2/reddit_vgg/features_$datasetName
indexSavePath=/media/wtheisen/scratch2/reddit_vgg
...
#Feature Extraction
# python3 featureExtractionDriver.py --inputFileList "${indexSavePath}/${datasetName}_filelist.txt" --outputdir $featureFolder --PE 12 --det PHASH --desc PHASH --kmax 5000 --jobNum 0 --numJobs 1
# RETVAL=$?
# if [ $RETVAL -ne 0 ]; then
